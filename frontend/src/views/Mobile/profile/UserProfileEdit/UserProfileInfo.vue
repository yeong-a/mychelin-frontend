  ...
  <div id="body-wrap">
    ...
    <div class="body-sub-wrap">
      <div class="d-flex justify-content-between">
        <p>전화번호</p>
        <p class="profile-info">전화번호 하드코딩 없음
      ...
      <div class="d-flex justify-content-between">
        <p>이메일</p>
        <input type="tel" class="profile-input" placeholder="이메일 하드코딩 없음">
      </div>
      <hr>
    ...
    <div class="body-sub-wrap">
      <div class="d-flex justify-content-between">
        ...
        <div class="form-check form-switch">
          <input class="form-check-input"> <!-- type="checkbox"에러 -->
        </div>
      </div>
      <hr>
      <div class="d-flex justify-content-between">
...
export default {
  ...
  created() {
    ...
    UserApi.requestProfile(nickname)
    .then(res => {
